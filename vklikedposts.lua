-- --------------------------------------------------
-- Получение постов, которые пролайкал конкретный человек на всей стены группы или человека ВК.
-- Если у постов на целевой стене более 1000 лайков, то возможна некорректная работа скрипта
-- --------------------------------------------------
